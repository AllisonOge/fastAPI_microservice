...
desc: A FastAPI microservice using python libraries and Firebase
"""
...
def signUp_by_email(**kwargs):
    try:
        ...
        uid, display_name, email, email_verified, phone_number, photo_url, password, disabled = itemgetter(
            'uid', 'display_name', 'email', 'email_verified', 'phone_number', 'photo_url', 'password', 'disabled')(kwargs)
        print('user does not exist')
        auth.create_user(uid=uid, display_name=display_name, email=email, email_verified=email_verified,
